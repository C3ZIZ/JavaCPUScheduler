...
|------------------|---------------------------------------------------------|-------------------------------------|
| **CPU-Scheduling**       | Basic site scheduler on Github by Aryan Darji. | [Github](https://github.com/Aryan-Darji-07/CPU-Scheduling)      |
| **Process Scheduling Solver**    | Open-source online scheduler providing vairous algorithms showing most relevant info for each process. | [boonsuen](https://process-scheduling-solver.boonsuen.com/) |
